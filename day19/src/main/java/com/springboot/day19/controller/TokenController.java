...
import com.springboot.day19.TokenResult;
...
import com.springboot.day19.jpa.UserInfoJPA;
...
public class TokenController {
        ...
        if (appId == null || appId.trim() == "") {
            ...
            // 验证appSecret是否存在
                ...
                // 超时 -> 生成newToken -> 更新dbToken -> 更新内存Token -> 返回newToken
                    ...
                    long second = TimeUnit.MILLISECONDS.toSeconds(currenTime - dbBuildTime);
    ...
    private String createNewToken(String appId){
        ...
        return Jwts.builder()
                ...
                .signWith(SignatureAlgorithm.HS256, "HuangHongAuthv1.0.0")
                .compact();
    }
