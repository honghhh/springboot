package com.springboot.day24.config;
...
@EnableJpaRepositories(
        ...
        basePackages = {"com.springboot.day24.user"}) //设置用户数据源所应用到的包
public class UserDataSourceConfigurer {
    ...
    public LocalContainerEntityManagerFactoryBean entityManagerFactoryUser(EntityManagerFactoryBuilder builder) {
        return builder.dataSource(userDataSource)
                .properties(getVendorPropreties(userDataSource))
                .packages(new String[]{"com.springboot.day24.user"}) // 设置应用creditDataSource的基础包名
    ...
    // 获取jpa配置信息
    private Map<String, String> getVendorPropreties(DataSource dataSource) {
